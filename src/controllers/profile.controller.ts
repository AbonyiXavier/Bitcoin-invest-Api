...
export const addProfile = async (req: Request, res: Response) => {
  ...
  export const getProfile = async (req: Request, res: Response) => {
    try {        
      const user = await Profile.find({ }).populate([{"path":"owner", "model":"User",  "select": "name email _id emailConfirm blocked"}]).exec()        
  ...
  export const editProfile = async (req: Request, res: Response) => {
    try {
        ...
        const profile = await Profile.findOne({ _id: id }).populate([{"path":"owner", "model":"User",  "select": "name email _id emailConfirm blocked"}]).exec()  
